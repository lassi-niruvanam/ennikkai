...
export class எண்ணிக்கை {
  ...
  private async _கிளி_தயாரிப்பு(): Promise<void> {
    if (this.விண்மீன்) {
      ...
      this.கிளியை_மறந்துவிடு = await this.கிளி.அங்கீகரிக்கப்பட்ட_உறுப்படிகளை_கேள்ளு({
        செ: (தகவல்கள்) => {
          this.விண்மீன்_தகவல்கள் =
  ...
  async பரிந்துரையு(பரிந்துரை: முறைமை_தகவல்_வரிசை) {
    (await this.கிளியைப்_பெறு()).பரிந்துரையு({பரிந்துரை})
  }

  async அங்கீகரி(பரிந்துரை: பிணையம்_பரிந்துரை<முறைமை_தகவல்_வரிசை>) {
    (await this.கிளியைப்_பெறு()).அங்கீகரி({பரிந்துரை})
  }
...
function எண்ணிக்கை_தகவல்கள்_வடிவூட்டத்துக்கு_மாறு(
  ...
  for (const வ of வரிசைகள்) {
    ...
    if (வகை === "இடஞ்சார்") {
      ...
      if (!அடிமானங்கள்) throw new Error(`${குறியீடு} என்று எண்ணுரு முறைமைக்காக அடிமானங்கள் தேவை.`)
