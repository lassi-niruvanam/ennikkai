...
export class எண்ணிக்கை {
  ...
  constructor({ விண்மீன் }: { விண்மீன்?: Constellation }) {
    ...
    this.நடவடிக்கைகள் =
      new EventEmitter() as TypedEmitter<எண்ணிக்கை_நடவடிக்கைகள்>;
  ...
  async கிளியைப்_பெறு(): Promise<எண்ணிக்கை_கிளி> {
    return (
      this.கிளி ||
      (await new Promise((தீர்வு) =>
        this.நடவடிக்கைகள்.once("கிளி தயார்", தீர்வு),
      ))
    );
  }
...
function எண்ணிக்கை_தகவல்கள்_வடிவூட்டத்துக்கு_மாறு(
  ...
  for (const வ of வரிசைகள்) {
    ...
    if (வகை === "இடஞ்சார்") {
      ...
      if (!அடிமானங்கள்)
        throw new Error(
          `${குறியீடு} என்று எண்ணுரு முறைமைக்காக அடிமானங்கள் தேவை.`,
        );
